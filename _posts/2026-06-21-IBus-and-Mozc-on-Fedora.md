...
## 事前準備
結論、IBus WaylandにMozcを組み合わせる方向で決定した。
...
Discord(やSlack、VS Code)といった「Electron（Chromium）製」のアプリケーションをWayland上で起動すると、IBusによる日本語入力が正常に受け付けられない問題に遭遇した。
